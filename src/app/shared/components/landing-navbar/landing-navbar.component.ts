...
@Component({
    ...
    <header class="fixed top-0 z-1000 flex w-full items-center justify-between bg-white px-8 py-4 text-slate-800 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border-b border-slate-100"> 
        ...
        <nav class="hidden lg:block">
            ...
            <li><a href="/register" class="px-4 py-2 text-[15px] font-semibold text-slate-600 no-underline transition-all duration-200 hover:text-[#0891B2] hover:bg-slate-50 rounded-lg">SignUp</a></li>
            </ul>
        </nav>
        <div class="flex items-center">
            <button class="rounded-xl bg-blue-600 px-6 py-2 text-[14px] font-bold text-white shadow-[0_4px_12px_rgba(8,145,178,0.25)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(8,145,178,0.35)] active:translate-y-0"
            routerLink="/register">
            Book an Appointment
            </button>
        </div>
