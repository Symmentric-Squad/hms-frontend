...
import { AppointmentResponse, MedicalHistoryRequest, MedicalHistoryResponse, PatientResponse } from "../../models/doctor.model";
import { UpdateUserRequest } from "../../../admin/models/admin.model";
...
export class PatientDetails implements OnInit {
    ...
    onUpdateModalSubmit(event: ModalSubmitEvent): void {
        ...
        // this.doctorService.updateUser(this.patientId, updateRequest).subscribe({
        //     next: (response) => {
    ...
    onAddReportSubmit(event: ModalSubmitEvent): void {
        ...
        this.doctorService.addMedicalHistory(this.patientId, medicalHistoryRequest).subscribe({
            next: (response) => {
    ...
    confirmDelete(): void {
        ...
        // this.doctorService.deleteUser(this.patientId).subscribe({
        //     next: (response) => {
