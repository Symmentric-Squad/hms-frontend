...
@Component({
    ...
    <div class="admin-shell">
      ...
      <div class="admin-main" [class.expanded]="sidebarCollapsed">
        <header class="admin-topbar">
          ...
          <div class="topbar-user" *ngIf="currentUser">
  ...
  `,
  styles: [`
    .admin-shell { display: flex; min-height: 100vh; font-family: 'Segoe UI', sans-serif; background: #f0f4f8; }
    .admin-sidebar { width: 240px; min-height: 100vh; background: linear-gradient(180deg, #0a1628 0%, #0d2149 100%); display: flex; flex-direction: column; position: fixed; left: 0; top: 0; bottom: 0; z-index: 100; transition: width 0.3s ease; box-shadow: 3px 0 20px rgba(0,0,0,0.15); }
